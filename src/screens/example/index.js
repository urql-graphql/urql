...
require("../../components/theme/index.css");

const images = {
  city: require("../../../static/city.jpg"),
  kat: require("../../../static/kat.png"),
  logo: require("../../../static/formidable-logo.svg"),
  markdown: require("../../../static/markdown.png")
};
      ...
      <Spectacle theme={theme}>
        <Deck transition={["zoom", "slide"]} transitionDuration={500}>
          ...
          <Slide transition={["zoom", "fade"]} bgColor="primary" notes="<ul><li>talk about that</li><li>and that</li></ul>">
            <CodePane
              lang="jsx"
              source={require("raw!./assets/deck-example.md")}
              margin="20px auto"
            />
          </Slide>
