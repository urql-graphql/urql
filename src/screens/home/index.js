      ...
      <React.Fragment>
        <div className="Hero">
          ...
          <h2 className="Hero-Heading u-noMargin">
            A <strong>React.js based</strong> library for creating{" "}
            <strong>
        ...
        <div className="Container">
          <div className="Grid Grid--gutters">
            ...
            <p className="Grid-cell">
              <a
                className="btn btn--pink u-nowrap"
                href="http://stack.formidable.com/spectacle"
              >
                View Live Demo
              </a>
            </p>
          ...
          <div className="u-noMarginTop Grid Grid--guttersLg Grid--top">
            ...
            <div className="Grid-cell Copy--large">
              <h2 className="Subheading u-noMargin">Features</h2>
              ...
              <h3 className="Heading">Live-Preview Your Code</h3>
              <p>
                Show people more than just a code block - demo the final project
                in real-time without leaving your presentation deck.
              </p>
              <h3 className="Heading">
                Auto-Size Text, Image Dimming, and More
              </h3>
              <p>
                On top of all of Spectacle's helpful features, you can also make
                your presentation look amazing with auto-formatting, easy
                theming abilities, image dimming, and lots of other fun touches.
              </p>
            </div>
          </div>
        </div>
