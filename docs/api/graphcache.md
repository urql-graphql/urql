...
| ----------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| writeData                                                                                                                                       | `(delta: SerializedEntries) => Promise<void>` | This provided method must be able to                                                                                                                                                   |
| accept an object of key-value entries that will be persisted to the storage. This method is called as a batch of updated entries becomes ready. |
...
| readMetadata                                                                                                                                    | `() => Promise<SerializedRequest[]>`          | This provided method must be able to read the persisted metdata that has previously been written using `writeMetadata`. It's only called on startup.                                   |
