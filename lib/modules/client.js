...
class Client {
  ...
  executeQuery(queryObject, skipCache) {
    return new Promise(async (resolve, reject) => {
      ...
      const hash = (0, _hash.hashString)(body); // Check cache for hash
      ...
      if (this.store[hash] && !skipCache) {
        ...
        try {
          ...
          if (response.data) {
            ...
            const typeNames = (_response$data = response.data, (0, _typenames.gankTypeNamesFromResponse)(_response$data)); // Store data in cache, using serialized query as key
    ...
    return new Promise(async (resolve, reject) => {
      ...
      try {
        ...
        if (response.data) {
          ...
          _ref = (_response$data2 = response.data, (0, _typenames.gankTypeNamesFromResponse)(_response$data2)), this.updateSubscribers(_ref, response);
